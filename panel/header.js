...
Volcanos(chat.ONACTION, {_init: function(can) {},
	...
	debug: function(event, can) { location.href = can.misc.MergeURL(can, {debug: "true"}, true) },
	release: function(event, can) { location.href = can.misc.MergeURL(can, {debug: "false"}, true) },
