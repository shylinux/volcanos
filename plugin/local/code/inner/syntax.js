Volcanos(chat.ONSYNTAX, {
	...
	css: {
		...
		keyword: {
			"$body": code.KEYWORD, "$fieldset": code.KEYWORD, "$input": code.KEYWORD, "$inputs": code.KEYWORD,
			...
			"plugin": code.KEYWORD, "option": code.KEYWORD, "action": code.KEYWORD, "output": code.KEYWORD, "status": code.KEYWORD,
			"container": code.KEYWORD, "item": code.KEYWORD, "board": code.KEYWORD,
			...
			"tab-size": code.FUNCTION, "white-space": code.FUNCTION, "word-break": code.FUNCTION, "letter-space": code.FUNCTION,
			"text-align": code.FUNCTION, "vertical-align": code.FUNCTION,
			...
			"float": code.FUNCTION, "clear": code.FUNCTION, "overflow": code.FUNCTION, "visibility": code.FUNCTION,
			"display": code.FUNCTION, "position": code.FUNCTION, "z-index": code.FUNCTION, "cursor": code.FUNCTION,
			"left": code.FUNCTION, "top": code.FUNCTION, "right": code.FUNCTION, "bottom": code.FUNCTION,
			"flex": code.FUNCTION, "flex-direction": code.FUNCTION, "flex-wrap": code.FUNCTION,
			"align-items": code.FUNCTION, "justify-content": code.FUNCTION, "gap": code.FUNCTION,
			"flex-grow": code.FUNCTION, "flex-shrink": code.FUNCTION,
			"opacity": code.FUNCTION, "transform": code.FUNCTION, "translate": code.FUNCTION, "rotate": code.FUNCTION,
			"transition": code.FUNCTION, "animation": code.FUNCTION, "@keyframes": code.KEYWORD,
			"stroke": code.FUNCTION, "stroke-width": code.FUNCTION, "fill": code.FUNCTION, "object-fit": code.FUNCTION,
			...
			"black": code.CONSTANT, "white": code.CONSTANT, "silver": code.CONSTANT, "gray": code.CONSTANT,
			"red": code.CONSTANT, "blue": code.CONSTANT, "cyan": code.CONSTANT, "aliceblue": code.CONSTANT,
			"green": code.CONSTANT,
			...
			"none": code.CONSTANT, "unset": code.CONSTANT,
