Volcanos(chat.ONIMPORT, {
    init: function(can, msg, cb, output, action, option) {output.innerHTML = "";
        ...
        can.page.Append(can, output, [{include: ["require/shylinux.com/x/echarts/echarts.js", function(event) {
            can.page.Append(can, output, [{include: ["require/shylinux.com/x/echarts/china.js", function(event) {
