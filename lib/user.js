Volcanos("user", {
	...
	theme: function(can, name) { var list = []
		can.user.mod.isCmd && list.push(chat.CMD)
		var cmd = can.user.mod.cmd||can._root.Action.Conf("tool.0.index")
		cmd && list.push(can.base.replaceAll(cmd, ".", " "))
		...
		can.page.styleClass(can, document.body, list.join(lex.SP))
	},
	title: function(text) {
