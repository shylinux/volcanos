Volcanos("page", {
	...
	styleValue: function(can, key) { const styles = getComputedStyle(document.body); return styles.getPropertyValue(key) },
	styleValueInt: function(can, key) { return parseInt(can.base.trimSuffix(can.page.styleValue(can, key), "px")) }
})
