Volcanos("misc", {Message: function(event, can) { var msg = {} 
	...
	MergeURL: function(can, objs, clear) {
		...
		objs.cmd && (path = can.base.Path(path.indexOf("/chat/") == 0? path: "/chat", ice.CMD, objs.cmd)), delete(objs.cmd)
		objs.website && (path = can.base.Path(path.indexOf("/chat/") == 0? path: "/chat", web.WEBSITE, objs.website)), delete(objs.website)
